...
<head>
  ...
  <script src="http://cdnjs.cloudflare.com/ajax/libs/waypoints/1.0.3/waypoints.min.js"></script>
          ...
          <div class="modal-body">
            ...
            <div class="formgroup">
              <div class="input-group">
                ...
                <input type="text" class="form-control" name="user" placeholder="Username" required="required" id="user">
              </div>
            </div>
            <div class="form-group">
              <div class="input-group">
                <span class="input-group-addon"><i class="fa fa-lock"></i></span>
                <input type="password" class="form-control" name="clave" placeholder="Password" required="required" id="clave">
              </div>
            </div>
            <div class="form-group">
